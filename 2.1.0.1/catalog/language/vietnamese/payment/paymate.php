...
// Help
$_['help_password']					= 'Chỉ cần sử dụng một số mật khẩu ngẫu nhiên. Điều này sẽ được sử dụng để đảm bảo rằng các thông tin thanh toán không được can thiệp sau khi được gửi đến các cổng thanh toán.';
